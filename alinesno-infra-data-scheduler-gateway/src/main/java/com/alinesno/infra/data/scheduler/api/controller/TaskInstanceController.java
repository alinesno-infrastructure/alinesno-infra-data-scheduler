...
@RequestMapping("/api/infra/data/scheduler/taskInstance")
public class TaskInstanceController extends BaseController<TaskInstanceEntity, ITaskInstanceService> {

    @Autowired
    private ITaskInstanceService service;
    ...
    @Override
    public ITaskInstanceService getFeign() {
        return this.service;
    }
}
