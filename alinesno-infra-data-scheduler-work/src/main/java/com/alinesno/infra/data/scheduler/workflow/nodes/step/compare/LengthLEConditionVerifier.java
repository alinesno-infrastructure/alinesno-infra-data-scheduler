package com.alinesno.infra.data.scheduler.workflow.nodes.step.compare;

import java.util.List;

public class LengthLEConditionVerifier implements ConditionVerifier {
    @Override
    public boolean isSupported(String compare) {
        return compare.equals(CompareTypeEnums.LEN_LE.getValue());
    }
