...
public class ProcessDefineTest {
    ...
    public void processExecutorTest() {
        ...
        shellTask.setTaskType(ExecutorTypeEnums.SHELL.getCode());
        ...
        pythonTask.setTaskType(ExecutorTypeEnums.PYTHON.getCode());
        ...
        sqlTask.setTaskType(ExecutorTypeEnums.SQL.getCode());
        ...
        httpTask.setTaskType(ExecutorTypeEnums.HTTP.getCode());
        ...
        jarTask.setTaskType(ExecutorTypeEnums.JAR.getCode());
        ...
        mavenTask.setTaskType(ExecutorTypeEnums.MAVEN.getCode());
