<template>
  <div>
  <el-scrollbar style="height:calc(100vh - 180px)" ref="scrollbarRef" >
...
async function fetchNodes() {
  if (!currentProcessDefinitionId.value || !currentExecuteId.value) {
    return
  }

    getExecutedFlowNodes(currentProcessDefinitionId.value , currentExecuteId.value).then(resp => {
...
const getList = (pId , eId) => {
  currentProcessDefinitionId.value = pId
  currentExecuteId.value = eId
}
