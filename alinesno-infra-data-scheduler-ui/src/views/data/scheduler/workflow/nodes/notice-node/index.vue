      ...
      <div class="settings-form">
        <el-form :model="formData" label-width="auto" label-position="top">
          <el-form-item label="通知渠道">
            <IMSelector :nodeModel="props.nodeModel" v-model="formData.imId" />
          </el-form-item>
          ...
          <el-form-item label="重试次数">
            <el-input-number v-model="formData.retryCount" :step="1" />
          </el-form-item>
...
import IMSelector from '@/views/data/scheduler/workflow/components/IMSelector'
...
function confirmAndSave() {
  ...
  // 配置
  formData.value.noticeContent = chatDataCode.value
}
...
onMounted(() => {
  auditEditorRef.value.setRawScript(formData.value.noticeContent)
})
