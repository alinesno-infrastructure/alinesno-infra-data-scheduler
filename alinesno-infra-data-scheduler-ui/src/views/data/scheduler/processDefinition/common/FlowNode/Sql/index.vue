<template>
  <div class="flow-row">
    ...
    <FlowSqlSetting ref="flowSqlSetting" @close="isActive = false" />
  </div>
</template>
...
import FlowSqlSetting from '../../FlowDrawer/Sql/index.vue';
...
function open(selectNode) {
  ...
  flowSqlSetting.value.showDrawer(selectNode);
}
