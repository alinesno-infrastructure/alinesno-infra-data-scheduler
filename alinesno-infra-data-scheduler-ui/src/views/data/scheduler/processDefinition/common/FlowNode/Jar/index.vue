<template>
  <div class="flow-row">
    ...
    <FlowJarSetting ref="flowJarSetting" @close="isActive = false" />
  </div>
</template>
...
import FlowJarSetting from '../../FlowDrawer/Jar/index.vue';
...
function open(selectNode) {
  ...
  flowJarSetting.value.showDrawer(selectNode);
}
