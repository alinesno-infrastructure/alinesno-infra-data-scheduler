<template>
  <div class="flow-row">
    ...
    <FlowShellSetting ref="flowShellSetting" @close="isActive = false" />
  </div>
</template>
...
import FlowShellSetting from '../../FlowDrawer/Shell/index.vue';
...
const flowShellSetting = ref(null);
...
function open(node) {
  ...
  isActive.value = true;
  //  打开配置
  flowShellSetting.value.showDrawer(node);
}
