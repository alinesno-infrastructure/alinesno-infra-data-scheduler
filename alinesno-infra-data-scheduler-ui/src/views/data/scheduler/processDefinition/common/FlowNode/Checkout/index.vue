<template>
  <div class="flow-row">
    <div class="flow-box">
      <div class="flow-item" :class="{ 'flow-item-active': isActive }">
        <div class="flow-node-box" :class="{ 'has-error': node.error }">
          <div class="node-name node-checkout">
    ...
    <FlowCheckoutSetting ref="flowCheckoutSetting" @close="isActive = false" />
  </div>
</template>
...
import FlowCheckoutSetting from '../../FlowDrawer/Checkout/index.vue';
...
const flowCheckoutSetting = ref(null);
...
function open(selectNode) {
  ...
  flowCheckoutSetting.value.showDrawer(selectNode);
}
