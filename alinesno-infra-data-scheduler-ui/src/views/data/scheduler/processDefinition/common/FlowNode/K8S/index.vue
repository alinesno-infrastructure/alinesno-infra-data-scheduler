<template>
  <div class="flow-row">
    ...
    <FlowK8SSetting ref="flowK8SSetting" @close="isActive = false" />
  </div>
</template>
...
import FlowK8SSetting from '../../FlowDrawer/K8S/index.vue';
...
function open(node) {
  ...
  isActive.value = true;
  //  打开配置
  flowK8SSetting.value.showDrawer(node);
}
