<template>
  <div class="flow-row">
    ...
    <FlowMavenSetting ref="flowMavenSetting" @close="isActive = false" />
  </div>
</template>
...
import FlowMavenSetting from '../../FlowDrawer/Maven/index.vue';
...
const flowMavenSetting = ref(null);
...
function open(selectNode) {
  ...
  flowMavenSetting.value.showDrawer(selectNode);
}
