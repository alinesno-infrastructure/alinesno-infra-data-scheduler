<template>
  <div class="flow-row">
    ...
    <FlowHttpSetting ref="flowHttpSetting" @close="isActive = false" />
  </div>
</template>
...
import FlowHttpSetting from '../../FlowDrawer/Http/index.vue';
...
const flowHttpSetting = ref(null);
