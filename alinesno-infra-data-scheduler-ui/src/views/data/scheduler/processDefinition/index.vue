                ...
                <el-table-column label="操作" align="center" width="200" class-name="small-padding fixed-width">
                   <template #default="scope">
                      <el-tooltip content="修改" placement="top" v-if="scope.row.ProcessDefinitionId !== 1">
                         <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:ProcessDefinition:edit']">修改</el-button>
                      </el-tooltip>
                      <el-tooltip content="删除" placement="top" v-if="scope.row.ProcessDefinitionId !== 1">
                         <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:ProcessDefinition:remove']">删除</el-button>
                      </el-tooltip>
                          ...
                          <el-dropdown style="margin-top:2px;" :hide-on-click="false" @command="(command) => handleCommand(command, scope.row)">
                                ...
                                <template #dropdown>
                                   <el-dropdown-menu>
                                      ...
                                      <el-dropdown-item command="handleProcessDefinitionLog" icon="Operation" style="font-size:13px"  v-hasPermi="['monitor:job:query']">调度日志</el-dropdown-item>
                                   </el-dropdown-menu>
                                </template>
                          </el-dropdown>
                      </el-tooltip>
